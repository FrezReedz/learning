	...
	<table class="login">
		...
		<tr>
			...
			<td><input type="text" name="nick" <?php recordar("nick"); ?> >
				<span class="errorform"><?php echo $errores["nick"] ?></td>
		</tr>
		<tr>
